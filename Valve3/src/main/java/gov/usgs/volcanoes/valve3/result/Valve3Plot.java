...
/**
 * Result which contains plot and file system information (which format, where, size).
 *
 * @author Dan Cervelli
 */
public class Valve3Plot extends Result {
  public enum OutputType {
    ...
    /**
     * Get OutputType enum value given string.
     * @param s string
     * @return
     */
   ...
   * @throws Valve3Exception when various parameters are illegal
   */
  public Valve3Plot(HttpServletRequest request, int componentCount) throws Valve3Exception {
    ...
    outputType = OutputType.fromString(StringUtils.stringToString(request.getParameter("o"),
                                                                  "png"));
    if (outputType == null) {
