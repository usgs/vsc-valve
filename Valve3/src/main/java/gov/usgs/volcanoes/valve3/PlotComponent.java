...
/**
 * Keeps set of parameters to generate valve plot component. A plot can contain several components.
 *
 * @author Dan Cervelli
 */
public class PlotComponent {
   ...
   * @throws Valve3Exception when there's an issue parsing time values
   */
   ...
   * @throws Valve3Exception when time string is illeagal
   */
  ...
  /**
   * If option 'color' was set for the component, return color for it's hex representation.
   *
   * @return null if 'color' option wasn't set
   * @throws Valve3Exception when there's a problem with the colorString
   */
