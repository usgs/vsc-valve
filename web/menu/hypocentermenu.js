/** @fileoverview  
 * 
 * function menu for hypocentermenu.html 
 *
 * @author Dan Cervelli
 */

/**
  *  Called for hypocentermenu.html, allows access to form elements via menu object.
 ...
 */
create_hypocentermenu = function(menu) {
	
	menu.formName	= "hypocenterForm";
	menu.boxName	= "hypocenterBox";
