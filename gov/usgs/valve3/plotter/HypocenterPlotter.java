...
//		this.endLoc = new Point2D.Double(e,n);
		...
		case COUNTS:
			String bs	= Util.stringToString(comp.get("cntsBin"), "day");
			...
			String ra   = Util.stringToString(comp.get("cntsAxis"), "C");
